...
ios_base::sync_with_stdio(false);
  ...
  for(i=0;i<8;i++)
  {
  	cout<<"For "<<i+1<<"th   panel FAR_mp "<<far_mpt[i]<<endl;
  	cout<<"For "<<i+1<<"th   panel FAR_th "<<far_mpp[i]<<endl;
  	cout<<"Efficiency of "<<i+1<<"th panel  "<<eff[i]<<endl;
  }
  double s;
  for(i=0;i<8;i++)
  s+=eff[i];
  s/=8;
  cout<<"Average efficiency  "<<s<<endl;
return 0;
}
